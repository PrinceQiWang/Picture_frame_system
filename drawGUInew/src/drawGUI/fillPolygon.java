...
public class fillPolygon extends drawings{
    ...
    void draw(Graphics2D g2d) {
    	...
    	MyPolygon2 mplg = new MyPolygon2(x, y,x1,y1,x2,y2);
        ...
        if (bianshu <= bianshuMax) {
            ...
            g2d.fillPolygon(x, y, bianshu);
            
            round = "area:"+df.format(mplg.r*bianshu);
            area = "round:"+df.format(mplg.r*0.5*mplg.r*bianshu)+"";
            ...
            mplg = new MyPolygon2(x, y,x1,y1,x2,y2);
	...
	class MyPolygon2 {// 求正多边形的顶点坐标
	    ...
	    public MyPolygon2(int[] x, int[] y,int startX1,int startY1,int startX2,int startY2) {
	        this.x = x;
	        this.y = y;
	        this.startX = startX1;
	        this.startY = startY1;
